      ...
      <Container>
        <div className="prose prose-slate mx-auto max-w-3xl dark:prose-invert">
          ...
          <p>
            ...
            Бурлуцким Олегом Алексеевичем (далее — Оператор).
          </p>
          <p>
          ...
          <p>
            ...
            Пользователю веб-сайта https://piligrim30.ru.
          </p>
          <p>
            2.9.{" "}
            <strong>
          ...
          <p>
            <strong>Цель обработки:</strong> заключение, исполнение и
          ...
          <p>
            ...
            и законных интересов оператора или третьих лиц.
          </p>
          <p>
          ...
          <p>
            ...
            Оператора bfl-30rus@yandex.ru с пометкой «Актуализация персональных
            данных».
          </p>
          <p>
            8.4. Срок обработки персональных данных определяется достижением
            целей, для которых были собраны персональные данные. Пользователь
            может в любой момент отозвать свое согласие на обработку
            персональных данных, направив Оператору уведомление посредством
            электронной почты на электронный адрес Оператора bfl-30rus@yandex.ru
          ...
          <p>
            ...
            срока действия согласия или отзыв согласия субъектом персональных
            данных.
          </p>
          ...
          <p>
            ...
            к Оператору с помощью электронной почты bfl-30rus@yandex.ru.
          </p>
          <p>

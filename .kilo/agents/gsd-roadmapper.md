...
Reference full template: `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/templates/state.md`.

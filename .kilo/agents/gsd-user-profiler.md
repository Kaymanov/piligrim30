...
<reference>
@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/user-profiling.md` to load:

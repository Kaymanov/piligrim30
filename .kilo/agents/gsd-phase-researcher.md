...
@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```

...
<!-- For checkpoint task examples and patterns, see @/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/checkpoints.md -->
...
See `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/workflows/verify-phase.md` for verification logic.

...
- Usage: Reference from command with `@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/iamroot/Документы/MyProjects/PP30/.kilo/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/iamroot/Документы/MyProjects/PP30/.kilo/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

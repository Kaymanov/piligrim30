...
```
Agent(
  prompt="Read /home/iamroot/Документы/MyProjects/PP30/.kilo/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/templates/VALIDATION.md`

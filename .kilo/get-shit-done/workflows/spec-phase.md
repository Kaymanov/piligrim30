...
```bash
INIT=$(node "/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/templates/spec.md.

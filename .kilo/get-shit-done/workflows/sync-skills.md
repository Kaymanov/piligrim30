...
INSTALL_JS_GLOBAL="/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.

...
Key references:
- @/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/ui-brand.md (display patterns)
- @/home/iamroot/Документы/MyProjects/PP30/.kilo/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/USER-PROFILE.md" "/home/iamroot/Документы/MyProjects/PP30/.kilo/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/user-profiling.md`
...
Reference: @/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/iamroot/Документы/MyProjects/PP30/.kilo/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/iamroot/Документы/MyProjects/PP30/.kilo/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/iamroot/Документы/MyProjects/PP30/.kilo/AGENTS.md"
...
```bash
BACKUP_PATH="/home/iamroot/Документы/MyProjects/PP30/.kilo/USER-PROFILE.backup.md"
```
...
Your profile:    /home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/iamroot/Документы/MyProjects/PP30/.kilo/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /home/iamroot/Документы/MyProjects/PP30/.kilo/AGENTS.md
```

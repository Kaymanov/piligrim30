...
- **Global scope**: `/home/iamroot/Документы/MyProjects/PP30/.kilo/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/iamroot/Документы/MyProjects/PP30/.kilo/notes/`)
...
2. Glob `/home/iamroot/Документы/MyProjects/PP30/.kilo/notes/*.md` (if directory exists) — global notes
...
Global (/home/iamroot/Документы/MyProjects/PP30/.kilo/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/iamroot/Документы/MyProjects/PP30/.kilo/notes/` — works in any directory

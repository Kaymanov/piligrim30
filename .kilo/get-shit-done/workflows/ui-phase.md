...
```markdown
Read /home/iamroot/Документы/MyProjects/PP30/.kilo/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/iamroot/Документы/MyProjects/PP30/.kilo/agents/gsd-ui-checker.md for instructions.

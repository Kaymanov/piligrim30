...
```
Agent(
  prompt="Read /home/iamroot/Документы/MyProjects/PP30/.kilo/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/templates/SECURITY.md`

...
<template>
@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/workflows/transition.md`.
...
- Follow @/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/workflows/diagnose-issues.md

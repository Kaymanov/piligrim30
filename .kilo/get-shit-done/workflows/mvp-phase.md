...
<required_reading>
@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/user-story-template.md
@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/spidr-splitting.md
@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/spidr-splitting.md`. Briefly:

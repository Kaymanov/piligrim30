...
<required_reading>
@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/ai-frameworks.md
@/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/iamroot/Документы/MyProjects/PP30/.kilo/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/iamroot/Документы/MyProjects/PP30/.kilo/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/iamroot/Документы/MyProjects/PP30/.kilo/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/iamroot/Документы/MyProjects/PP30/.kilo/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/iamroot/Документы/MyProjects/PP30/.kilo/agents/gsd-eval-planner.md for instructions.
